...
if (isset($_POST["save"])) {
    ...
    for ($i = 0; $i < $count; $i++) {
        ...
        if ($updatequery) {
            ...
            echo "<script>window.location = 'SocialApps.php'</script>";
        } else {
...
<body>
        ...
        <nav>
            ...
            <div class="nav">
                ...
                <ul id="hamitems">
                    ...
                    <li class="nav-links"><a href="SocialApps.php" class="active">Social Apps</a>
                ...
                <div class="feacuture-box-container">
                    <div class="feacture-box user-profile-box">
                        <div class="user-profile">
                            <img src="<?php echo $memberprofile ?>" alt="">
                        </div>
            ...
            <div class="profile-edit-container" id="profile-edit">
                ...
                <div class="profile-info">
                    <form action="<?php $_SERVER["PHP_SELF"] ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="flex-column">
                            <label for="surname">SurNamee </label>
                        </div>
                        <div class="pf-input">
                            <i class="fa-solid fa-user"></i>
    ...
    <section class="media-search">
        <form action="<?php $_SERVER["PHP_SELF"] ?>" method="post">
            <h2>Search Campaign Technique Here!</h2>
    ...
    <div class="campaign-section">
        ...
        if (isset($_POST["btnsearch"])) {
            ...
            $searchQuery = "SELECT * FROM campaigntb
            WHERE CampaignStatus = 'Avaliable'
            ...
            if ($count > 0) {
                ...
                for ($i = 0; $i < $count; $i++) {
                    $query = "SELECT * FROM campaigntb
                                    WHERE CampaignStatus = 'Avaliable'
                                    AND CampaignName LIKE '%$search%' LIMIT $i,1";
                    ...
                    for ($j = 0; $j < $count1; $j++) {
                        ...
                        $campimage1 = $data["CampaignImage1"];
                        $campfees = $data["CampaignFees"];
                    }

                    echo "<div class='box'>
                                <div class='camp-search-page'>
                                    <div class='cart-img'>
                                        <img src='$campimage1'>
                                    </div>
                                    <div class='cart-description'>
                                        <h1>$campname</h1>
                                        <p><span>$</span>$campfees</p>
                                        <a href='CampaignDetail.php?campaignID=$campid'>See More</a>
                                    </div>
                                </div>
                            </div>";
                }
                ...
                echo '<div class="not-found-container">
                        <img src="Memberimage/confused.png" alt="Crying Image">
                        <h1>Sorry, search result not found.</h1>
                        <p>Nothing is turning up with that word or phrase. Please try entering.</p>
                        <h3>recommended campaigns below</h3>
                    </div>';
            }
        }
        ?>
    ...
    <footer>
        <div class="footer">
            <div class="footer-logo">
                <h2>SMC</h2>
                <p>Social Media Campaigns</p>
                <span>You are here (Social Apps) </span>
            </div>
